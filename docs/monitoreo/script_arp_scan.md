...
Este script   se encarga de monitorear la red local para detectar nuevos dispositivos (o dispositivos que desaparecen) y notificar al administrador por correo electrónico.
...
7.3. Desarrollo del Script   (infra_scan.sh)
